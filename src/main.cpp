...
uint256 hashGenesisBlock("0x0661682c038a64cb43b6bf3255f08bb4b13e8629e81e97a1c4c428a96ef4a441");
...
{
    // Peacecoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0661682c038a64cb43b6bf3255f08bb4b13e8629e81e97a1c4c428a96ef4a441");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1412508801;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086180550;
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running Peacecoin with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
